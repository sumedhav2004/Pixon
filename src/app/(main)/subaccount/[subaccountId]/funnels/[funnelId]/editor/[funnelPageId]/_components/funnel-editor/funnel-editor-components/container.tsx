...
const Container = ({element}: Props) => {
  ...
  console.log('🔍 DRAG DATA:', componentType);
  switch(componentType){
    ...
    case 'paymentForm': 
      ...
      break
    default:
    console.warn(`Unhandled drop type: ${componentType}`)
    break
  }
}
  ...
  return (
    <div style={styles} className={
      clsx('relative p-4 transition-all group', {
    ...
    >
      <Badge className={
        clsx('absolute -top-[23px] -left-[1px] rounded-none rounded-t-lg hidden',{
