...
export const saveActivityLogsNotification = async({
  ...
  console.log("[saveActivityLogsNotification] args:", {
    agencyId,
    subaccountId,
    description,
  });
...
export const upsertSubAccount = async (subAccount: SubAccount) => {
  ...
  const isCreating = !subAccount.id; // ✅ FIXED: don't check db if no ID
  const finalId = isCreating ? v4() : subAccount.id;
        ...
        create: [
          {
            name: "Launchpad",
            icon: "clipboardIcon",
            link: `/subaccount/${finalId}/launchpad`,
          },
          {
            name: "Settings",
            icon: "settings",
            link: `/subaccount/${finalId}/settings`,
          },
          {
            name: "Funnels",
            icon: "pipelines",
            link: `/subaccount/${finalId}/funnels`,
          },
          {
            name: "Media",
            icon: "database",
            link: `/subaccount/${finalId}/media`,
          },
          {
            name: "Automations",
            icon: "chip",
            link: `/subaccount/${finalId}/automations`,
          },
          {
            name: "Pipelines",
            icon: "flag",
            link: `/subaccount/${finalId}/pipelines`,
          },
          {
            name: "Contacts",
            icon: "person",
            link: `/subaccount/${finalId}/contacts`,
          },
          {
            name: "Dashboard",
            icon: "category",
            link: `/subaccount/${finalId}`,
          },
        ],
      },
    },
